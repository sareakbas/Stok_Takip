    ...
    public partial class FixCascadeIssue : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StockMovementAllocations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StockMovementAllocations_StockLots_LotId",
                        column: x => x.LotId,
                        principalTable: "StockLots",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StockMovementAllocations_StockMovements_MovementId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockMovementAllocations_LotId",
                table: "StockMovementAllocations",
                column: "LotId");

            migrationBuilder.CreateIndex(
                name: "IX_StockMovementAllocations_MovementId",
                table: "StockMovementAllocations",
                column: "MovementId");
